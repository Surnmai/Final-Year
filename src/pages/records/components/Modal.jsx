...
const Modal = ({ title, children, isOpen, onClose, onAction, actionLabel }) => {
  ...
  return (
    <div className="fixed left-0 top-0 z-[80] flex h-full w-full items-center justify-center bg-modal_bg bg-opacity-90">
      <div className="relative w-11/12 rounded-xl border border-gray-200 bg-white shadow-sm md:w-1/2 lg:w-1/3 dark:border-neutral-800 dark:bg-modal_bg">
